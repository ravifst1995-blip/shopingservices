 ...
 * />
 */
export default function EasyPrintingSetup({
  imageSrc,
  title = "Easy Printing Setup",
  description =
    "Install printer in few easy steps. Just click the button to get started with setting up the printer.",
  ctaText = "PRINTER SETUP",
  ctaHref,
  onCtaClick,
  className = "",
  ...
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <h2
          id="eps-title"
          className="text-center text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl lg:text-5xl"
        >
          {title}
        </h2>
          ...
          <div className="mx-auto w-full max-w-xl text-center md:text-left">
            ...
            <div className="mt-8 text-center ">
              {ctaHref ? (
                <Link
                  href={ctaHref}
                  className="inline-flex text-center buttonHoverStyle  items-center justify-center rounded-full px-8 py-4 text-3xl font-semibold text-white shadow-sm transition hover:shadow-md focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500/70"
